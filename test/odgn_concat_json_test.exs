defmodule OdgnConcatJsonTest do
  ...
  test "values" do
    ...
    assert ConcatJSON.parse_all( ~s( ), 'true\n', %{arr: 0, current: :value, line: 1, obj: 0, pos: 5})
    == {:ok, ['true']}
    ...
    assert ConcatJSON.parse_all( "star\n", 'super', %{arr: 0, current: :value, line: 1, obj: 0, pos: 5})
      == {:ok, ['superstar']}
  ...
  test "arrays" do
    ...
    assert ConcatJSON.parse_all(~s([ "one", )) ==
      {:continue, [], "", '["one",',
        %{arr: 1, pos: 9, line: 1, obj: 0, current: :array}}
  ...
  test "comments" do
    ...
    # incomplete comment
    assert ConcatJSON.parse_all( ~s("good" #))
      == {:continue, ['"good"'], "", [], %{arr: 0, current: :comment, line: 1, obj: 0, pos: 8}}
  ...
  assert ConcatJSON.parse_all( a )
    == {:continue, ['{"foo":"bar"}'], "", '{"', %{arr: 0, line: 3, obj: 1, pos: 6, current: :string}}

  assert ConcatJSON.parse_all( b, '{"', %{arr: 0, line: 3, obj: 1, pos: 6, current: nil} )
    == {:continue, ['{"qux":"corge"}'], "", '{"baz":{', %{arr: 0, line: 6, obj: 2, pos: 4, current: :string}}
  ...
  assert ConcatJSON.parse_all( c, '{"baz":{', %{arr: 0, line: 6, obj: 2, pos: 4, current: nil} )
    ...
    == {:continue, ['{"qux":"corge"}'], "", '{"baz":', %{arr: 0, line: 3, obj: 1, pos: 15, current: :string}}

    assert ConcatJSON.parse_all( c, '{"baz":', %{arr: 0, line: 3, obj: 1, pos: 15, current: nil})
    == {:continue, [], "", '{"baz":{"waldo":"thud"', %{arr: 0, line: 5, obj: 1, pos: 1, current: :string}}

    assert ConcatJSON.parse_all( d, '{"baz":{"waldo":"thud"', %{arr: 0, line: 5, obj: 1, pos: 1, current: nil})
    == {:ok, ['{"baz":{"waldo":"thud"}}']}
  ...
  test "parse all" do
    ...
    assert ConcatJSON.parse_all('[ "hello"') ==
             {:continue, [], "", '["hello"',
              %{arr: 1, line: 1, obj: 0, pos: 9, current: :array}}
